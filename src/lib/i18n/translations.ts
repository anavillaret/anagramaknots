...
export const translations = {
  en: {
    ...
    cart: {
      ...
      subtotal: 'Subtotal',
      currency: 'Currency',
      shipping: 'Each piece ships in its own gift box · Shipping calculated per piece at checkout',
    ...
    shipping: {
      ...
      rows: [
        { region: 'Portugal', delivery: '1–3 business days — €6 per piece' },
        { region: 'Spain', delivery: '2–5 business days — €9 per piece' },
        { region: 'Rest of Europe', delivery: '5–7 business days — €14 per piece' },
        { region: 'Rest of World', delivery: '5–9 business days — €21 per piece' },
      ],
      ...
      faqs: [
        ...
        { q: 'How is each piece packed?', a: 'Every piece is individually packaged in its own branded box, with its own handwritten animal story card and natural padding — ready to give as a gift, exactly as if you had ordered it on its own. No plastic.' },
        { q: 'If I order more than one piece, is shipping charged per piece?', a: 'Yes — because each piece is packaged individually in its own box and handled as a separate, complete gift, shipping is calculated per piece. This ensures every animal arrives in perfect condition, beautifully presented.' },
  ...
  pt: {
    ...
    cart: {
      ...
      subtotal: 'Subtotal',
      currency: 'Moeda',
      shipping: 'Cada peça é enviada na sua própria caixa · Envio calculado por peça no checkout',
    ...
    shipping: {
      ...
      colDelivery: 'Entrega',
      rows: [
        { region: 'Portugal', delivery: '1–3 dias úteis — €6 por peça' },
        { region: 'Espanha', delivery: '2–5 dias úteis — €9 por peça' },
        { region: 'Resto da Europa', delivery: '5–7 dias úteis — €14 por peça' },
        { region: 'Resto do Mundo', delivery: '5–9 dias úteis — €21 por peça' },
      ],
      ...
      faqs: [
        ...
        { q: 'Como é embalada cada peça?', a: 'Cada peça é embalada individualmente na sua própria caixa com a marca, com o seu próprio cartão escrito à mão com a história do animal e enchimento natural — pronta a oferecer, exactamente como se tivesses encomendado apenas essa peça. Sem plástico.' },
        { q: 'Se encomendar mais do que uma peça, o envio é cobrado por peça?', a: 'Sim — porque cada peça é embalada individualmente na sua própria caixa e tratada como um presente completo e independente, o envio é calculado por peça. Assim garantimos que cada animal chega em perfeito estado, apresentado com todo o cuidado.' },

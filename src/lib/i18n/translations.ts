...
export const translations = {
  en: {
    ...
    story: {
      ...
      journeySub: 'Before the animals, there was the yarn. Ana\'s early experiments — testing stitches, playing with colour, learning by hand.',
  ...
  pt: {
    ...
    story: {
      ...
      journeySub: 'Antes dos animais, havia o fio. As primeiras experiências da Ana — testar pontos, brincar com cores, aprender com as mãos.',

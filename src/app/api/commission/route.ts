...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
          <h2 style="color: #008080; margin-bottom: 24px;">New Commission Request</h2>
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr><td style="padding: 8px 0; color: #8A837C; font-size: 13px;">Email</td><td style="padding: 8px 0; font-size: 13px;"><a href="mailto:${email}" style="color: #008080;">${email}</a></td></tr>
          ...
          <div style="margin-top: 20px; padding: 16px; background: #F5EFE0; font-size: 13px; line-height: 1.7; white-space: pre-wrap;">${description}</div>
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
          <h2 style="color: #008080; margin-bottom: 8px;">Thank you, ${name}.</h2>
          ...
          <p style="color: #8A837C; font-size: 14px; line-height: 1.6; margin-top: 16px;">
            In the meantime, feel free to browse the collection or follow the making process on Instagram <a href="https://www.instagram.com/anagrama_knots/" style="color: #008080;">@anagrama_knots</a>.
          </p>
          <p style="margin-top: 32px; font-size: 13px; color: #8A837C;">
            ※ Anagrama · Art in Knots<br/>
            <a href="mailto:anagramaknots@gmail.com" style="color: #008080;">anagramaknots@gmail.com</a>
          </p>
        </div>
      `,
    })
